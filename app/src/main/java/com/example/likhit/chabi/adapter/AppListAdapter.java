...
import com.example.likhit.chabi.activity.AppListQuestion;
...
public class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.ViewHolder> implements Filterable{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        String uri = "@drawable/"+app.getAppName().toLowerCase()+app.getImageId();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("appQuestionJSONString",app.getAppQuestion().toString());
