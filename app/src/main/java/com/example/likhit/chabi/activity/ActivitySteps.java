...
public class ActivitySteps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        steps=appListQuestionData.getString("stepsJSONString");
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0: // Fragment # 0 - This will show FirstFragment
                    return Fragment_steps.newInstance(1, appName,appId,questionId,steps);
                case 1: // Fragment # 0 - This will show SecondFragment
                    return Fragment_steps.newInstance(2, appName,appId,questionId,steps);
                case 2: // Fragment # 1 - This will show ThirdFragment
                    return Fragment_steps.newInstance(3, appName,appId,questionId,steps);
                case 3: // Fragment # 1 - This will show FourthFragment
                    return Fragment_steps.newInstance(4, appName,appId,questionId,steps);
                case 4: // Fragment # 1 - This will show FifthFragment
                    return Fragment_steps.newInstance(5, appName,appId,questionId,steps);
