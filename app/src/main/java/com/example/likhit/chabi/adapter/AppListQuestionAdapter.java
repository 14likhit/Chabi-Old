...
import com.example.likhit.chabi.activity.ActivitySteps;
...
public class AppListQuestionAdapter extends RecyclerView.Adapter<AppListQuestionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String uri = "@drawable/"+appName.toLowerCase()+appListQuestion.getAppId();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("stepsJSONString",appListQuestion.getSteps().toString());
